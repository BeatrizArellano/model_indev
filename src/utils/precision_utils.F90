...
module precision_utils
  ...
  public :: rel_default, abs_default

  ! Defaults scale with machine epsilon for rk
  real(rk), parameter :: rel_default = 1.0e4_rk * epsilon(1.0_rk)  ! ≈2e-12 for real64
  real(rk), parameter :: abs_default = 1.0e2_rk * epsilon(1.0_rk)  ! ≈2e-14 for real64
